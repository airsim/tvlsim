...
namespace AIRINV {
  ...
  fillFromRouting (const stdair::FlightDate& iFlightDate) {
  ...
  // ////////////////////////////////////////////////////////////////////
  void FlightDateHelper::
  recalculateAvailabilities (stdair::FlightDate& ioFlightDate) {
    ...
    for (stdair::SegmentDateList_T::const_iterator itSegmentDate =
      ...
      stdair::SegmentDate* lCurrentSegmentDate_ptr = *itSegmentDate;
      assert (lCurrentSegmentDate_ptr != NULL);
      //SegmentDateHelper::recalculateAvailabilities (*lCurrentSegmentDate_ptr);
    }
  }

  // ////////////////////////////////////////////////////////////////////
  void FlightDateHelper::reset (stdair::FlightDate& ioFlightDate) {
    ...
    for (stdair::SegmentDateList_T::const_iterator itSegmentDate =
      ...
      stdair::SegmentDate* lCurrentSegmentDate_ptr = *itSegmentDate;
      assert (lCurrentSegmentDate_ptr != NULL);
      //SegmentDateHelper::reset (*lCurrentSegmentDate_ptr);
    }
  }
