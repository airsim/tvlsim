#ifndef __AVLCAL_BOM_BOMABSTRACT_HPP
#define __AVLCAL_BOM_BOMABSTRACT_HPP
...
operator>> (std::basic_istream<charT, traits>& ioIn,
            AVLCAL::BomAbstract& ioBom) {
  // Fill Bom object with input stream
  ioBom.fromStream (ioIn);
  return ioIn;
}

#endif // __AVLCAL_BOM_BOMABSTRACT_HPP
