...
namespace TRADEMGEN {
  ...
  public:
    ...
    const stdair::NbOfRequests_T& getTotalNumberOfRequestsToBeGenerated (const DemandStreamKey&) const;

    /** Check whether enough requests have already been generated for
        the demand stream which corresponds to the given key. */
    const bool stillHavingRequestsToBeGenerated (const stdair::DemandStreamKeyStr_T&) const;
