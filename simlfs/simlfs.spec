...
%package doc
Summary:        HTML documentation for the SIMLFS library
Group:          Documentation
BuildArch:      noarch
BuildRequires:  doxygen, texlive-latex, texlive-dvips, ghostscript

%description doc
This package contains the documentation in the HTML format of the SIMLFS
library. The documentation is the same as at the SIMLFS web page.
