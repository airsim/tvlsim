#ifndef __SIMLFS_BOM_BOMABSTRACT_HPP
#define __SIMLFS_BOM_BOMABSTRACT_HPP
...
operator>> (std::basic_istream<charT, traits>& ioIn,
            SIMLFS::BomAbstract& ioBom) {
  // Fill Bom object with input stream
  ioBom.fromStream (ioIn);
  return ioIn;
}

#endif // __SIMLFS_BOM_BOMABSTRACT_HPP
